...
class OtpTextField extends StatefulWidget {
  ...
  OtpTextField({
    ...
    this.cursorColor,
    this.disabledBorderColor = const Color(0xff379FFF),
    this.enabledBorderColor = const Color(0xff379FFF),
    this.borderColor = const Color(0xff379FFF),
    this.focusedBorderColor = const Color(0xff379FFF),
